...
The purpose of work is to research different implementatons of melanoma recognition and classification on the picture.
...
Statistic of tarining and validation for model kerasSimple.h5 in folder models 
